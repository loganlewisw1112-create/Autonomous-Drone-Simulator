...
export const demoBasic: ScenarioConfig = {
  ...
  seed: 42,
  droneCount: 3,
  // Baseline demo: a uniform X10 patrol fleet, so lane-to-lane timing stays
  // symmetric and the sweep reads cleanly.
...
export const demoSAR: ScenarioConfig = {
  ...
  seed: 7331,
  droneCount: 3,
  // SAR doctrine: weatherproof X10D search ships, with an Astro Max carrying the
  // mapping payload on the third lane.
